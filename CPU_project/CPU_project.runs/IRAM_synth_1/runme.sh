...
HD_PWD='D:/Documents/SUSTech/Grade2/Computer_Organization/FPGA_CPU/CPU_project/CPU_project.runs/IRAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IRAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IRAM.tcl
